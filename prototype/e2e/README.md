...
기대값은 `../ralphathon/validation/independent-cases.json`과 고정 수기 식을 기준으로 한다. fixture 생성은 입력/session만 만들며 계산 엔진의 출력을 기대값으로 복사하지 않는다. 최종 결과·수정 근거·한계·09 인계는 `../ralphathon/implementation/08-integration-quality.md`에 기록한다.
