...
| curated/data_centers.json | Digital Edge·Equinix·Digital Realty·NAVER·Kakao·LG U+·SK브로드밴드·KINX·NHN Cloud·kt cloud·현대건설 공식 시설 페이지 및 발표자료 | 공개 주소·운영 상태·시설 규모를 2026-09-08 확인하고 VWorld 주소 API로 좌표화. 같은 물리 시설의 복수 입주사는 중복 제거하고 위치 비공개 및 계획·공사 단계 시설 제외 |
