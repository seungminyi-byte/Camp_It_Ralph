...
| curated/data_centers.json | Digital Edge·Equinix·Digital Realty·NAVER·Kakao 공식 시설 페이지 및 발표자료 | 공개 주소·운영 상태·시설 규모를 2026-09-08 교차 확인하고 VWorld 주소 API로 좌표화. 위치 비공개 및 계획·공사 단계 시설 제외 |
