...
- 기존 배포 주소: https://grand-site-dc.vercel.app · 현재 작업의 배포 여부와 구분하세요.
...
2. 일반 클라우드·엣지·AIDC와 목표 수전용량을 각각 입력합니다. 유형 변경은 비용·용량을 덮어쓰지 않습니다.
...
2026-09-08: 1차 사업검토 개편을 로컬 구현했습니다. 가구 격자, 사업조건과 면적 계산, 부지별 비용·협의 기록, 민감도 표, 비교·보고서와 AI 의견 유효성 검사를 연결했습니다.
